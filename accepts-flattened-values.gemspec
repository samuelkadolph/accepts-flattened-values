Gem::Specification.new do |s|
  ...
  s.description = 'accepts-flattened-values is mixin for activerecord that flattens single values from a has and ' +
                  'belongs to many assocations into a string and vice versa.'

  s.author   = 'Samuel Kadolph'
  s.email    = 'samuel@kadolph.com'
  s.homepage = 'http://github.com/samuelkadolph/accepts-flattened-values'
